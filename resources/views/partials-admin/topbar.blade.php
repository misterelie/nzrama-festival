        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            ...
            <li class="dropdown">
                ...
                @if(Auth::user()->profile_photo != null)
                    <img src="{{ asset('UsersPhoto/'.Auth::user()->profile_photo) }}" alt="profile-user" class="rounded-circle">
                @else
                    <!--SINON AFFICHER L'IMAGE PAR DEFAUT -->
                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="profile-user" class="rounded-circle"  width="50px" height="50px">
                 </a>
                @endif
        ...
        <ul class="list-unstyled topbar-nav mb-0">
            ...
            {{-- <li class="creat-btn">
                <div class="nav-link"><a class="btn btn-sm btn-soft-primary" href="#" role="button"><i
                            class="fas fa-plus mr-2"></i></a></div>
            </li> --}}
        </ul>
    </nav><!-- end navbar-->
</div><!-- Top Bar End -->